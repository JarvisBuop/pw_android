...
class MoveBehavior : androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior<View>() {
    companion object {
        val TAG = "Behavior"
    }
    ...
    public var dx = 0
    public var dy = 0
    override fun onTouchEvent(parent: androidx.coordinatorlayout.widget.CoordinatorLayout, child: View, event: MotionEvent): Boolean {
    ...
    override fun getScrimOpacity(parent: androidx.coordinatorlayout.widget.CoordinatorLayout, child: View): Float {
        Log.d(TAG, "getScrimOpacity child ${child.javaClass.simpleName}")
        return super.getScrimOpacity(parent, child)
    }

    override fun getScrimColor(parent: androidx.coordinatorlayout.widget.CoordinatorLayout, child: View): Int {
        Log.d(TAG, "getScrimColor child ${child.javaClass.simpleName} ")
        return super.getScrimColor(parent, child)
    }

    override fun blocksInteractionBelow(parent: androidx.coordinatorlayout.widget.CoordinatorLayout, child: View): Boolean {
