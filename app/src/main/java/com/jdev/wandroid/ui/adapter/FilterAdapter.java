package com.jdev.wandroid.ui.adapter;
...
import com.jdev.wandroid.helper.FilterTypeHelper;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterHolder>{
    ...
    public FilterHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.app_filter_item_layout,
                parent, false);
