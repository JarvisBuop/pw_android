 ...
 * 仿淘宝详情;
 */
class ScrollViewContainer : FrameLayout {
        ...
        when (ev.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (canPullUp && mCurrentViewIndex == 0 && mEvents == 0) {
                    mMoveDistanceY += dy
                    Log.e(TAG, "dy:  " + dy + " / " + mMoveDistanceY)
                    illegalDistance()
    ...
    class ScrollHelper {
        ...
        fun isTop(): Boolean {
            ...
            if (scrollableView is RecyclerView) {
                return HeaderScrollHelper.isRecyclerViewTop(scrollableView)
            }
        ...
        fun isBottom(): Boolean {
            ...
            if (scrollableView is RecyclerView) {
                return HeaderScrollHelper.isRecyclerViewBottom(scrollableView)
            }
            if (scrollableView is WebView) {
