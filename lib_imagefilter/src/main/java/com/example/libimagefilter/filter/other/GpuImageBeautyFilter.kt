package com.example.libimagefilter.filter.other
 ...
 * @see:
 * @description: thrid party 美颜
 *
 */

class GpuImageBeautyFilter : GPUImageFilter(NO_FILTER_VERTEX_SHADER, BILATERAL_FRAGMENT_SHADER) {
    ...
    override fun onInit() {
        ...
        toneLevel = 0.47f
        beautyLevel = 0.42f//0.8f
        brightLevel = 0.34f//0.6f
