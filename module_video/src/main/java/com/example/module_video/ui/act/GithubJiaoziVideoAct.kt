...
import com.example.module_video.jiaozi.CustomMedia.JZMediaSystemAssertFolder
...
import kotlinx.android.synthetic.main.layout_github_jiaozi.*
...
//        jzPlayer.thumbImageView.setImageResource(R.drawable.ic_launcher_background)
        ...
        vv.setVideoPath(
                Uri.parse("http://jzvd.nathen.cn/342a5f7ef6124a4a8faf00e738b8bee4/cf6d9db0bd4d41f59d09ea0a81e918fd-5287d2089db37e62345123a1be272f8b.mp4")
                        .toString())
        vv.start()
        vv.requestFocus()
    }
