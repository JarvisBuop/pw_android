package com.jdev.kit.widget.tablayout;
...
import com.jdev.kit.widget.tablayout.listener.OnTabSelectListener;
import com.jdev.kit.widget.tablayout.utils.UnreadMsgUtils;
 ...
 *
 * 已修改源码
 * github地址 @see https://github.com/H07000223/FlycoTabLayout/blob/master/README_CN.md
 */
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean mIndicatorMultiColor;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMultiColor = ta.getBoolean(R.styleable.SlidingTabLayout_tl_indicator_is_colors, false);
        ...
        float dimension = ta.getDimension(R.styleable.SlidingTabLayout_tl_select_textsize, 0);
        if (dimension > 0) {
            mTextSelectSize = dimension;
        } else {
...
//            mTextPaint.setTextSize(mTextsize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                if (mIndicatorMultiColor) {
                    mIndicatorDrawable.setColors(new int[]{mIndicatorStartColor, mIndicatorEndColor});
                    mIndicatorDrawable.setOrientation(GradientDrawable.Orientation.TL_BR);
                } else {
                    mIndicatorDrawable.setColor(mIndicatorColor);
                }
